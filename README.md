...
- efs-encryption-at-rest-enabled ([docs](https://github.com/hashicorp/policy-library-cis-aws-efs-terraform/blob/main/docs/policies/efs-encryption-at-rest-enabled.md) | [code](https://github.com/hashicorp/policy-library-cis-aws-efs-terraform/blob/main/policies/efs-encryption-at-rest-enabled.sentinel))
