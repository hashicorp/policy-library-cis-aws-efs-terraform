# (Beta) Pre-written Sentinel Policies for Center for Internet Security(CIS) AWS EFS Foundations Benchmark
...
2. If you have any issues or enhancement suggestions to the library, please create [a new GitHub issue](https://github.com/hashicorp/policy-library-cis-aws-efs-terraform/issues/new).

3. Alternatively, we welcome any contributions that improve the impact of this library! To learn more about contributing and suggesting changes to this library, refer to the [contributing guide](https://github.com/hashicorp/policy-library-cis-aws-efs-terraform/blob/main/CONTRIBUTING.md).

### Policies Included

- Ensure that encryption is enabled for EFS file systems ([docs](https://github.com/hashicorp/policy-library-cis-aws-efs-terraform/blob/main/docs/policies/efs-encryption-at-rest-enabled.md) | [code](https://github.com/hashicorp/policy-library-cis-aws-efs-terraform/blob/main/policies/efs-encryption-at-rest-enabled.sentinel))
